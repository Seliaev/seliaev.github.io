...
const DEFAULT_DATA = {
  ...
  "hero": {
    ...
    "subtitle": "Лендинги под ключ, Telegram и VK боты — от идеи до готового продукта за 2–5 дней. \n\nЧистый код, современный дизайн, результат.",
    "stat1Label": "проектов",
  ...
  "projects": [
    ...
    },
    {
      "id": "09-olvpn",
      "name": "OLVPN Bot",
      "description": "Telegram-бот для автоматической выдачи ключей Outline VPN.",
      "category": "bot",
      "badge": "Telegram Bot",
      "badgeColor": "rgba(6,182,212,0.85)",
      "time": "5",
    ...
    },
    {
      ...
      "description": "Веб-интерфейс управления Telegram-ботом: запуск, остановка, логи.",
      "category": "bot",
      "badge": "Web + Bot",
    ...
    },
    {
      ...
      "description": "Мониторинг статуса электропечей в реальном времени. \nРазработано для промышленного применения.",
      "category": "bot",
      "badge": "Monitoring",
    ...
    },
    {
      "id": "13-zhabka",
      "name": "Жабка-бот 🐸",
      "description": "Telegram-бот для автоматической рассылки мема с жабой каждую среду. \nПотому что традиция мема.",
      "category": "bot",
      "badge": "Telegram Bot",
