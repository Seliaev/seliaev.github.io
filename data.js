...
const DEFAULT_DATA = {
  ...
  projects: [
    ...
    // ─── РЕАЛЬНЫЕ ПРОЕКТЫ С GITHUB ────────────────────────────────
    {
      id: "09-olvpn",
      name: "OLVPN Bot",
      description: "Telegram-бот для автоматической выдачи ключей Outline VPN. Более 7 звёзд на GitHub.",
      category: "bot",
      badge: "Telegram Bot",
      badgeColor: "rgba(6,182,212,0.85)",
      time: "—",
      ...
      tags: ["Python", "Telegram", "Outline VPN", "GitHub ⭐7"],
      demoUrl: "",
  ...
  admin: {
    /** Хранится как btoa(password). По умолчанию: "admin" → btoa("admin") = "YWRtaW4=" */
  ...
  settings: {
     ...
     * Chat ID: напишите боту /start, откройте https://api.telegram.org/bot{TOKEN}/getUpdates
     */
    tgBotToken: "",
    tgChatId: ""
  }
 ...
 * @param {string} stored - Хранимый хеш.
 * @returns {boolean}
 */
