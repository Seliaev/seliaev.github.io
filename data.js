...
const DEFAULT_DATA = {
  ...
  settings: {
    /**
     * URL Cloudflare Worker для отправки Telegram-уведомлений.
     * Токен хранится в Worker (Secrets) — посетители его не видят.
     * Заполните после деплоя Worker: https://dash.cloudflare.com/
     */
    workerUrl: ""
  }
};
